...
const BANNER_DATA = {
    HEADING: "Trade like a Mogul",
    DESCRIPTION: "MC is your one-stop-shop for all your market data and analytical needs. ",
...
const FOOTER_DATA = {
    DESCRIPTION: "We are typically focused on result-based marketing in the digital world. Also, we evaluate your brand's needs and develop a powerful strategy that maximizes profits.",
    CONTACT_DETAILS: {
        HEADING: "Contact us",
        ADDRESS: "La trobe street docklands, Melbourne",
        MOBILE: "+1 61234567890",
        EMAIL: "nixlar@gmail.com"
    },
...
const MOCK_DATA = {
    HEADER, NAVBAR_DATA, BANNER_DATA, SERVICE_DATA, ABOUT_DATA, TESTIMONIAL_DATA, SOCIAL_DATA, FOOTER_DATA
};
